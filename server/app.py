...
socketio = sio.SocketIO(app, cors_allowed_origins=['http://localhost:8080', 'http://192.168.2.31:8080', 'http://192.168.25.220:8080', 'https://hoog3059.pythonanywhere.com', 'http://hoog3059.pythonanywhere.com'])
